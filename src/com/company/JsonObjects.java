...
public class JsonObjects {
    ...
    public void setJsonKeyValuePair(HashMap<String, String> jsonKeyValuePair) {
        this.jsonKeyValuePair = jsonKeyValuePair;
    }

    public HashMap<String, String> getJsonKeyValuePair() {
        return jsonKeyValuePair;
    }

    public ArrayList<HashMap> getFinalKeyValuePairObjects() {

        return finalKeyValuePairObjects;
    }
    public void setFinalKeyValuePairObjects(ArrayList<HashMap> finalKeyValuePairObjects) {
        this.finalKeyValuePairObjects = finalKeyValuePairObjects;
    }
 ...
 */
            ...
            do {
                ...
                if (!dataJsonFile.exists()) {
                    ...
                    if (obj.getClass().getName().contains("Array")) {
                        ...
                        System.out.println( "New file namely "+ newFileName +" produces" + gson.toJson(finalJsonObject));
                    }
                   /*
    ...
    public  boolean rulesOnObjects(ArrayList<String> rulesInstruction, String pairKey, String pairValue) {
